...
current_station = ""
current_path = {"railway": "国铁集团", "bureau": "北京局", "section": "客运段", "station": "北京南站"}
...
def init_sample_data():
    # 为北京南站添加示例数据
    station = railway_data["国铁集团"]["北京局"]["客运段"]["北京南站"]
    ...
    # 为北京西站添加示例数据
    station2 = railway_data["国铁集团"]["北京局"]["客运段"]["北京西站"]
    ...
    # 为上海虹桥站添加示例数据
    station3 = railway_data["国铁集团"]["上海局"]["客运段"]["上海虹桥站"]
...
def get_station_data():
    ...
    section = request.args.get('section', '客运段')
